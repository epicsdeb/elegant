...
PARAMETER lsrMdltr_param[N_LSRMDLTR_PARAMS] = {
    ...
    {"LASER_X0", "M", IS_DOUBLE, 0, (long)((char *)&lsrMdltr_example.laserX0), NULL, 0.0, 0, "laser horizontal offset"},
    {"LASER_Y0", "M", IS_DOUBLE, 0, (long)((char *)&lsrMdltr_example.laserY0), NULL, 0.0, 0, "laser vertical offset"},
...
ELEMENT_DESCRIPTION entity_description[N_TYPES] = {
    ...
    {  N_EMATRIX_PARAMS,  HAS_MATRIX|HAS_RF_MATRIX|HAS_LENGTH|MAY_CHANGE_ENERGY,  sizeof(EMATRIX),    ematrix_param     }, 
